...
return {
	rook = {
		...
		codename = STRINGS.QED_GRIFTER.AGENTS.ROOK.ALT_1.CODENAME,
	...
	rook_a = {
		...
		agentID = "rook",
		name = STRINGS.QED_GRIFTER.AGENTS.ROOK.NAME,
		fullname = STRINGS.QED_GRIFTER.AGENTS.ROOK.ALT_2.FULLNAME,
		codename = STRINGS.QED_GRIFTER.AGENTS.ROOK.ALT_2.CODENAME,
		...
		upgrades = {"augment_rook_ricochet", "item_rook_pistols_emp"},
	},
