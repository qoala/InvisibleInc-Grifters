...
return {
	...
	-- item_rook_pistols_empswitch = util.extend( commondefs.weapon_reloadable_template ) {
	-- 	name = STRINGS.QED_GRIFTER.ITEMS.ROOK_PISTOLS_EMPSWITCH,
	-- 	desc = STRINGS.QED_GRIFTER.ITEMS.ROOK_PISTOLS_EMPSWITCH_TOOLTIP,
	-- 	flavor = STRINGS.QED_GRIFTER.ITEMS.ROOK_PISTOLS_EMPSWITCH_FLAVOR,
	-- 	traits = {
	-- 		weaponType="pistol",
	-- 		baseDamage = 1,
	-- 		canSleep = true,
